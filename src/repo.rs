...
use crate::merge::{MergeFileInput, MergeFileOptions, MergeFileResult};
...
mod tests {
    ...
    /// merge files then return the result
    #[test]
    fn smoke_merge_file() {
        ...
        let index = repo.merge_commits(&commit4, &commit5, None).unwrap();
